...
def create_table_config_endpoint(
...
def update_table_config_endpoint(
...
@router.delete("/{table_configuration_id}", response_model=bool)
def delete_table_config_endpoint(
    table_configuration_id: int, db: Session = Depends(get_db)
):
